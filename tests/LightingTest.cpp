...
struct TestTriangle : Entity
{
  ...
  TestScene &testScene;
  TestTriangle(Window &_window, TestScene &testScene, glm::vec3 position, glm::vec3 rotation, glm::vec3 scale) : Entity(_window, {"Color", "Position", "Normal", "View", "Projection", "Model", "CameraPosition", "Lighting", "DirectionalLightShadowMaps", "SpotLightShadowMaps", "PointLightShadowMaps", "LightSpacePosition", "Fog"}, 3, {2, 1, 0}, 3, {{0, 100, 0}, {100, -100, 0}, {-100, -100, 0}}, position, rotation, scale, "TestTriangle"),
...
TestScene::TestScene(Window &window) : Scene(window, {0, 10, 10}, glm::normalize(glm::vec3(0, -1, -1)), 81.f),
                                       vml(*this)
{
  ...
  cubeEntity = std::make_shared<entities::Cube>((Window &)window, *this,
                                                ...
                                                glm::vec3(1, 1, 1),
                                                shaders::RuntimeConstants({"Lighting",
  ...
  auto skybox = std::make_shared<entities::SkyBox>(
      (Window &)window,
      *this,
      std::vector<std::string_view>({"images/skybox/right.jpg", "images/skybox/left.jpg", "images/skybox/top.jpg",
