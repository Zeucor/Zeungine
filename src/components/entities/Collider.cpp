...
zg::components::entities::EntityComponentCreateInfo zg::components::entities::ColliderFactory(const ColliderInfo& colliderInfo)
{
...
// 		EntityComponent("Collider"), info(info),
