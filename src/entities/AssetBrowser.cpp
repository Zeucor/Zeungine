...
// 	return std::make_shared<textures::Texture>(window.iRenderer, glm::ivec4(scaledIconSize.x, scaledIconSize.y, 1, 0),
// 																						 (void*)iconBitmap.get());
// }
...
// 	vertices = {{0, -actualNewSize.y, 0}, {actualNewSize.x, -actualNewSize.y, 0}, {actualNewSize.x, 0, 0}, {0, 0, 0}};
...
// 	size = actualNewSize;
// }
// AssetBrowser::AssetBrowser(zg::Window& window, zg::Scene& scene, glm::vec3 position, glm::quat rotation,
