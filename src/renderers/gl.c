...
static int glad_gl_find_extensions_gles1(GladGLContext *context) {
    const char *exts = NULL;
    char **exts_i = NULL;
    if (!glad_gl_get_extensions(context, &exts, &exts_i)) return 0;
...
static int glad_gl_find_extensions_glsc2(GladGLContext *context) {
    const char *exts = NULL;
    char **exts_i = NULL;
    if (!glad_gl_get_extensions(context, &exts, &exts_i)) return 0;
...
static void* glad_gles1_dlopen_handle(GladGLContext *context) {
#if GLAD_PLATFORM_APPLE
...
void gladLoaderUnloadGLES1Context(GladGLContext *context) {
    if (context->glad_loader_handle != NULL) {
        glad_close_dlopen_handle(context->glad_loader_handle);
        context->glad_loader_handle = NULL;
    }
