#ifdef _WIN32
#include <zg/modules/gl/windows/WIN32Window.hpp>
...
static LRESULT CALLBACK gl_wndproc(HWND hwnd, UINT msg, WPARAM wParam,
																	LPARAM lParam)
{
	struct RenderWindow* glWindow = (struct RenderWindow*)GetWindowLongPtr(hwnd, GWLP_USERDATA);
	switch (msg)
	{
	case WM_CREATE:
		{
			CREATESTRUCT* createStruct = (CREATESTRUCT*)lParam;
			glWindow = (RenderWindow*)createStruct->lpCreateParams;
