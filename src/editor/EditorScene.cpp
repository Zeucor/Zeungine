...
// 		// 	std::vector<Entity*>({closeOpenDialogButton, okayOpenDialogButton, openProjectDirectoryInput})))
// {
...
// };
// void EditorScene::onEntityAdded(const Entity& entity)
// {
...
// 	// // std::function<void(const Entity*&)> entityAddedFunction =
