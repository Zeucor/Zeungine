...
elseif(WINDOWS)
    ...
    if (LINUX)
        if("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
            set(openssl_BUILD_TYPE linux-x86_64)
        elseif("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "arm64")
            set(openssl_BUILD_TYPE linux-arm64)
        endif()
    elseif(MACOS)
        if("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "x86_64")
            set(openssl_BUILD_TYPE darwin64-x86_64-cc)
        elseif("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "arm64")
            set(openssl_BUILD_TYPE darwin64-arm64-cc)
        endif()
    elseif(IOS)
    endif()
    add_openssl_config("./Configure")
