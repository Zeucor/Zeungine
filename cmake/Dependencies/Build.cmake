...
if(ANDROID)
    ...
    set(openssl_MAKE make libssl.a libcrypto.a)
    set(openssl_MAKE_INSTALL make install libssl.a libcrypto.a)
elseif(WINDOWS)
    ...
    add_openssl_config(Configure)
    add_openssl_config(${openssl_BUILD_TYPE})
    set(openssl_MAKE nmake libssl.lib libcrypto.lib)
    set(openssl_MAKE_INSTALL nmake install libssl.lib libcrypto.lib)
else()
    add_openssl_config("./Configure")
    set(openssl_MAKE make libssl.a libcrypto.a)
    set(openssl_MAKE_INSTALL make install libssl.a libcrypto.a)
