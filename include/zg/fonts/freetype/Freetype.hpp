...
namespace zg::fonts::freetype
{
	...
	struct FreetypeFont
	{
		...
		void stringToScene(const std::string_view string, glm::vec3 position, glm::vec4 color, float fontSize,
		...
		void stringToEntity(const std::string_view string, glm::vec3 position, glm::vec4 color, float fontSize,
