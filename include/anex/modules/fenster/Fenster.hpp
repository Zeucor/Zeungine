...
namespace anex::modules::fenster
{
    ...
    struct fenster *f = 0;
		...
		int framerate = 60;
		FensterWindow(const char *title, const int32_t &windowWidth, const int32_t &windowHeight, const int32_t &windowX, const int32_t &windowY, const bool &borderless = false, const uint32_t &framerate = 60);
		~FensterWindow();
